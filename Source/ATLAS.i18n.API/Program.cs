...
try
{
    ...
    builder.Host.UseWindowsService(opts => opts.ServiceName = "ATLAS.i18n");
    ...
    Log.Information("ATLAS.i18n ready on {Urls}", string.Join(", ", app.Urls));
...
{
    Log.Fatal(ex, "ATLAS.i18n terminated unexpectedly.");
    return 1;
}
finally
{
