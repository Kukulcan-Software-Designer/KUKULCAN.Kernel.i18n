...
{
    /// <summary>
    /// Adds the KUKULCAN.Kernel.i18n API services to the specified <see cref="IServiceCollection"/>.
    /// </summary>
    ...
    public static IServiceCollection AddKukulcanI18NApi(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddOpenApi(opts =>
        {
            ...
            {
                doc.Info.Title = "KUKULCAN.Kernel.i18n — Internationalisation Service";
                doc.Info.Version = "v1";
