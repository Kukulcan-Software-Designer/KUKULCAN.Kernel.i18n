...
namespace KUKULCAN.Kernel.i18n.API.Middleware;
...
/// <see cref="Result{T}"/> and <see cref="KUKULCAN.Kernel.i18n.API.Extensions.ResultExtensions.ToActionResult{T}"/> converts
