...
public sealed class HealthEndpointTests : IAsyncLifetime
{
    private readonly TestcontainersContainer _postgres = new TestcontainersBuilder<TestcontainersContainer>()
        ...
        .WithEnvironment("POSTGRES_USER", "atlas")
        .WithEnvironment("POSTGRES_PASSWORD", "atlas_pass")
        .WithEnvironment("POSTGRES_DB", "atlas_i18n_test")
    ...
    public async Task InitializeAsync()
    {
        ...
        string conn = "Host=localhost;Port=55432;Database=atlas_i18n_test;Username=atlas;Password=atlas_pass;";
