...
public sealed class UpdateTranslationCommandValidatorTests
{
    ...
    [Fact] public void Validate_Valid_Passes() => _v.Validate(new UpdateTranslationCommand("CRM0001", "es-ES", "txt")).IsValid.Should().BeTrue();
    [Fact] public void Validate_EmptyText_Fails() => _v.Validate(new UpdateTranslationCommand("CRM0001", "es-ES", "")).IsValid.Should().BeFalse();
}
