...
namespace ATLAS.Kernel.i18n.Domain.UnitTests;
...
public sealed class TranslationTests
{
    ...
    {
        Result<Translation> result = Translation.Create(Guid.NewGuid(), "CRM0001", "es-ES", "Cliente");
    ...
    {
        Result<Translation> result = Translation.Create(Guid.NewGuid(), "CRM0001", "es-ES", "12345", maxLength: 5);
        result.IsSuccess.Should().BeTrue();
