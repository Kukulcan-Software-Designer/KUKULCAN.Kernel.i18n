...
public sealed class LanguageTests
{
    ...
    {
        Result<Language> result = Language.Create(Guid.NewGuid(), "es-ES", "Spanish", "Espanol");
    ...
    {
        Result<Language> created = Language.Create(Guid.NewGuid(), "en-US", "English", "English", isDefault: true);
